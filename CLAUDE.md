...
> Cuenta atrás visible ("Abriendo Maps en 3… 2… 1…") y botón **Ir ahora** para
> saltar la espera. Al llegar a 0 (o al pulsar el botón) se navega con
> `window.location.href` — misma pestaña, sin pestaña vacía. Si el dispositivo
> tiene Maps instalado, el SO lo intercepta y abre la app nativa; si no, carga
